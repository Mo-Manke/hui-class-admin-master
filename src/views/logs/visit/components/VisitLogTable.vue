...
<template>
  <el-table
    ...
    border
    empty-text="暂时没有数据哟"
    class="visit-log-table"
    @row-dblclick="onRowDblClick"
  >
    <el-table-column type="selection" width="55" align="center" />
    <el-table-column label="ID" prop="id" width="80" align="center" />
    <el-table-column label="页面" prop="page" min-width="160" :show-overflow-tooltip="true" />
    <el-table-column label="标题" prop="page_title" min-width="160" :show-overflow-tooltip="true" />
...
const emit = defineEmits<{
  (e: "detail", row: VisitLogItem): void;
  (e: "page-change", page: number): void;
  (e: "size-change", size: number): void;
}>();

// 双击行查看详情
const onRowDblClick = (row: VisitLogItem) => {
  emit("detail", row);
};
